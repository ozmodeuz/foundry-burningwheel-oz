...
export class Skill extends BWItem {
    ...
    calculateAptitude() {
        ...
        const root1exp = actor.data.data[this.data.data.root1].exp;
        const root2exp = this.data.data.root2 ? actor.data.data[this.data.data.root2].exp : root1exp;
    ...
    get rootStatExp() {
        if (this.actor) {
            ...
            if (this.data.data.root2) {
                const root1Shade = actor.data.data[this.data.data.root1].shade;
                const root2Shade = this.data.data.root2 ? actor.data.data[this.data.data.root2].shade : root1Shade;
